...
public:
  ...
  */
   ...
   * 
   */
  void SetColorCodeModeSupported (bool coloring);
  void SetColorCode (uint8_t color);
  uint8_t GetColorCode (void) const;

  void SetEnergyRecDbM (double energylvl);
...
private:
  ...
  double   m_energylvl;
  uint8_t  m_colorcode;           //!< BSS color code (6 bit used)
  ...
  bool     m_enable_coloring;    //!< Flag if Color Code Mode is supported
